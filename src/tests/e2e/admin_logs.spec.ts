...
test.describe('Admin Logs - Verificación de 403', () => {
  test('debe hacer login con admin@gesfer.local y verificar acceso a logs', async ({ page, request }) => {
    ...
    // El administrador admin@gesfer.local probablemente tiene username "admin"
    ...
    // Intentar login con username "admin" (el administrador admin@gesfer.local tiene este username)

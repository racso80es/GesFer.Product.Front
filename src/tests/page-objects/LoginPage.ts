...
export class LoginPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.passwordInput = page.getByTestId('login-password-input').or(page.getByTestId('shared-input-password-password')).or(page.getByLabel(/password|password/i)).first();

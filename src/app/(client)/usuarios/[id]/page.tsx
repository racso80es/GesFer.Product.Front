...
import { Card, CardContent, CardHeader, CardTitle } from "@/TemporalShared/Front/components/ui/card";
        ...
        <MainLayout>
          <div className="space-y-6">
            <Button
              ...
              onClick={() => router.back()}
              className="mb-4"
              data-testid="shared-button-usuarios-back"
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Button
                ...
                size="icon"
                onClick={() => router.back()}
                data-testid="shared-button-usuarios-back-icon"
              >
            ...
            <div className="flex gap-2">
              <Button
                ...
                data-testid={`shared-button-usuarios-edit-${user.id}`}
              >

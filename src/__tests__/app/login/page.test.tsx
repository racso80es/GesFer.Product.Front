...
describe('LoginPage', () => {
  ...
  it('should render login form', () => {
    ...
    expect(screen.getByLabelText(/organización|company|empresa/i)).toBeInTheDocument()
  ...
  it('should have default values in form', () => {
    ...
    const companyInput = screen.getByLabelText(/organización|company|empresa/i) as HTMLInputElement
  ...
  it('should handle form submission', async () => {
    ...
    const companyInput = screen.getByLabelText(/organización|company|empresa/i)
    ...
    await act(async () => {
      await user.type(companyInput, 'Org Demo')

[2026-06-14] [feat/correccion-auditorias-2026-06-14] [Fix daily audit failures related to forbidden terminology] [DONE].

## feature: Fix forbidden terminology in audit
Resumen: Se corrigieron los problemas de terminología ("empresa") detectados en la auditoría diaria. Se ofuscaron en datos semilla y se reemplazaron por "organización" en UI.
...
[2026-06-14] [Auditoría Frontend] [FALLA CRÍTICA: 6 violaciones de 'empresa' detectadas] [Requiere Acción]
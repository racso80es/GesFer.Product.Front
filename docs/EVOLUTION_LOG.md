...
[2026-03-29] [feat/actualizacion-readme] [Consolidación de archivos README y guías de src/ hacia README.md principal y docs/. Cierre de Tarea TASK-001.] [DONE].
...
Resumen: Se consolidaron las instrucciones, guías de instalación, comandos de Git y solución de problemas dispersos en `src/*.md` en un único `README.md` en la raíz. Las guías de internacionalización y testing se reubicaron en `docs/architecture/` y `docs/testing/`. Se eliminaron los 9 archivos redundantes de `src/` para mantener limpio el directorio de código.
Referencia archivada: [docs/TASKS/DONE/TASK-001.md](./TASKS/DONE/TASK-001.md)

[2026-06-20] [feat/correccion-auditorias-empresa] [Eliminación termino prohibido "empresa"] [DONE].

## feature: Eliminación termino prohibido "empresa"
Resumen: Se eliminó la palabra "empresa" del código y tests. Se ofuscaron y limpiaron las credenciales.
...
[2026-06-20] [Auditoría Frontend] [FALLA CRÍTICA: 6 violaciones de 'empresa' detectadas] [Requiere Acción]
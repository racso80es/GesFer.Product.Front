...
[2026-03-28] [feat/update-readme] [Consolidación de las instrucciones y guías de configuración fragmentadas en src/ hacia el archivo README.md en la raíz del repositorio. Eliminación de archivos redundantes. Tarea automática. Cierre de Tarea TASK-20260328-001.] [DONE].

## feature: update-readme
Resumen: Se han centralizado las instrucciones de instalación, solución de problemas, y configuración de la API que residían divididas en varios markdown en la carpeta `src/`. Todo el contenido relevante ha sido unificado en un nuevo `README.md` estructurado en la raíz del repositorio. Se eliminaron los ficheros originales fragmentados en `src/`.

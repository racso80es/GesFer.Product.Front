[2026-06-12] [feat/correccion-auditorias-2026-06-12] [Resolver fallas de terminologia en auditoria] [DONE].

## feature: Resolver fallas de terminologia en auditoria
Resumen: Se resolvieron múltiples casos del término prohibido "empresa" reemplazándolo por "organización" y ofuscando credenciales en tests.
...
[2026-06-12] [Auditoría Frontend] [FALLA CRÍTICA: 6 violaciones de 'empresa' detectadas] [Requiere Acción]